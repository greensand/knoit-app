...
class VerificationForm extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            div className = "text-help margin-bottom" > { mobile_number.touched ? mobile_number.error : '' } <
            /div> <
            Bootstrap.Button type = "submit"
            className = "btn-primary button form-control" > SUBMIT < /Bootstrap.Button> < /
            form >
        );
    }
}
...
function validate(value) {
    ...
    if (value.mobile_number < 7000000000 || value.mobile_number > 9999999999) {
